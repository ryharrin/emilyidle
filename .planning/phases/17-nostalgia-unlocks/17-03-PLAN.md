...
- Order is enforced:
  ...
  - Cannot buy chronograph until classic is unlocked (by milestone OR nostalgia unlock).
  - Cannot buy tourbillon until chronograph is unlocked.
- Buying an unlock:
...
- `nostalgiaResets: 1` and `nostalgiaPoints: 10`.
...
7. (Optional but valuable) Trigger a refund and confirm nostalgia balance/status updates accordingly.
