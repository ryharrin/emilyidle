...
must_haves:
  truths:
    - "Player can load an existing save (or start fresh) and reach the Vault tab without crashes"
    ...
    - "Save load and simulation tick still compile with identical public signatures"
  artifacts:
