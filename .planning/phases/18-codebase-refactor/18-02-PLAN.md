...
must_haves:
  ...
  key_links:
    ...
    - from: "src/game/state.ts"
      to: "src/game/data/milestones.ts"
      via: "import"
      pattern: "from\\s+\"\\./data/milestones\""
    - from: "src/game/state.ts"
      to: "src/game/data/setBonuses.ts"
      via: "import"
      pattern: "from\\s+\"\\./data/setBonuses\""
---
...
src/game/data/setBonuses.ts
  ...
  <action>
- Create `src/game/data` if it does not exist.
