...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    title: "Currencies",
    body: [
      "Cash ($): Your spendable money for catalog purchases and upgrades.",
      "Enjoyment: Powers career sessions and unlocks higher watch tiers.",
      "Cash comes from career salary and session payouts.",
      "Enjoyment comes from watch ownership and collection bonuses.",
      "Enjoyment gates unlock tiers; cash pays the purchase price.",
      "Career sessions cost enjoyment (first one is free).",
