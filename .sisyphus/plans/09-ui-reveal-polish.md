...
- [ ] Hide Workshop panel until close to first Workshop prestige
...
- [ ] Hide Maison panel until close to first Maison prestige
  - **Files**: `src/App.tsx`, `src/game/state.ts`
  - **Verification**: `pnpm run test:e2e`
  - **Parallelizable**: NO

- [ ] Hide upcoming unlock tags until the player is near the milestone
...
- [ ] Add subtle watch-inspired motifs (without new external deps)
