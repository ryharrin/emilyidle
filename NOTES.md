...
Planned Features:
- Have the watch catalog visually mimic a replica watch website for added immersion.
- Integrate the collection of watches into the game's core mechanics, making them more than just collectibles.
- Have the collection of watches impact gameplay, such as providing bonuses or unlocking new features.
- Hide tabs that are not yet relevant to the player to reduce clutter.
- Add a settings menu for customizing gameplay experience.
- Add a setting to toggle between light and dark mode for better accessibility.
- Add a setting to hide completed achievements from the achievements list.
- Add a setting to hide tabs that are no longer relevant to the player.
- Add a tutorial or help section to guide new players through the game's mechanics.
- Add detailed information about each watch, including history, specifications, and significance.
- Add a dev mode for testing purposes, allowing for easy unlocking of watches and resources, as well as modifying the rate of resource generation.
- Improve the mini game mechanics to make them more engaging and rewarding.
